...
export const ToastRoot = styled(RadixToast.Root, {
  ...
  variants: {
    variant: {
      warning: {
        border: '2px solid $colors$warningBase',
      },
      danger: {
        border: '2px solid $colors$dangerBase',
      },
      success: {
  ...
  variants: {
    ...
    variant: {
      warning: {
        ...
        color: '$gray100',
        boxShadow: `0 2px 10px $colors$warningBase`,
        '&:hover': {
          boxShadow: `inset 0 0 0 5px $colors$warningLow`,
          cursor: 'pointer',
        },
        '&:focus': { boxShadow: `0 0 0 2px $colors$warningBase` },
      },
      danger: {
        backgroundColor: '$dangerBase',
        color: '$gray100',
        boxShadow: `0 2px 10px $colors$dangerBase`,
        '&:hover': {
          boxShadow: `inset 0 0 0 5px $colors$dangerLow`,
          cursor: 'pointer',
        },
        '&:focus': { boxShadow: `0 0 0 2px $colors$dangerBase` },
      },
      success: {
